        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">Central Lombok</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center rounded-full bg-white" style={{width:'24px', height:'24px', flexShrink: 0}}>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">eleventrailss@gmail.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition">
              ...
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition">
              ...
              <a href={tiktokUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition">
              ...
              <a href={youtubeUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition">
