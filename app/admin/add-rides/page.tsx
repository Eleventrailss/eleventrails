...
export default function AddRidesPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Insert ride first to get ID for file renaming
      const { data: rideData, error: rideError } = await supabase
        ...
        .insert({
          ...
          primary_picture: null, // Will be updated after upload
          secondary_picture: null, // Will be updated after upload
      ...
      // Update ride with image URLs
      if (primaryPictureUrl || secondaryPictureUrl) {
        const { error: updateError } = await supabase
          .from('rides')
          .update({
            primary_picture: primaryPictureUrl || null,
            secondary_picture: secondaryPictureUrl || null,
          })
          .eq('id', rideId)
      ...
      const errorMessage = err.message || err.error?.message || 'Gagal menambahkan ride. Silakan coba lagi.'
